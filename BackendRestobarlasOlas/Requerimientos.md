...
* **Gestionar cuentas:** Faculta al administrador para activar o desactivar el acceso de personal y asignar roles con permisos limitados (ej. Cocina no puede ver reportes de ventas).
